...
//                 <Button variant="outlined" color="secondary" onClick={() => setFieldValue('old', '')}>
//                   Cancel
//                 </Button>
    ...
    <MainCard title="Change Password">
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          password: Yup.string()
            .required('New Password is required').notOneOf([Yup.ref('old')], 'New password cannot be the same as old password'),
